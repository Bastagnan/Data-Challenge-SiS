...
#  TRAINING LOOP
# --------------------
def train(model, data_dir='./', num_epochs=10, batch_size=16, lr=1e-3,
          n_frames=100, n_joints=22):
    ...
    for epoch in range(num_epochs):
        ...
        for motions, texts in tqdm(train_loader, desc=f"Epoch {epoch+1}/{num_epochs}"):
            ...
            # Forward pass with CLIP encoder
            pred_motion = model(texts)  # texts is a list[str], shape => (batch_size, motion_dim)
